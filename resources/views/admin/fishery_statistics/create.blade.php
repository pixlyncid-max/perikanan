...
@section('title', 'Tambah Data Statistik Pembudidaya')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Isi data statistik pembudidaya ikan Kalimantan Timur</p>
        </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.fishery-statistics.store') }}" class="space-y-6">
        @csrf
                    ...
                    <div>
                        ...
                        <select name="regency_city" id="regency_city" required
                            ...
                            @foreach($regencies as $regency)
                                <option value="{{ $regency }}" {{ old('regency_city') == $regency ? 'selected' : '' }}>{{ $regency }}</option>
                            @endforeach
                        </select>
                        @error('regency_city')
                            <p class="mt-1 text-sm text-red-500"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-400">Pilih salah satu dari 10 kabupaten/kota di Kalimantan Timur</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="year" id="year" required
                            ...
                            @for($y = date('Y') + 1; $y >= 2015; $y--)
                                <option value="{{ $y }}" {{ old('year') == $y ? 'selected' : ($y == date('Y') ? 'selected' : '') }}>{{ $y }}</option>
                            @endfor
                        </select>
                        @error('year')
                            <p class="mt-1 text-sm text-red-500"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="fish_farmer_count" id="fish_farmer_count"
                                   value="{{ old('fish_farmer_count') }}" min="0"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="shrimp_farmer_count" id="shrimp_farmer_count"
                                   value="{{ old('shrimp_farmer_count') }}" min="0"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="fisherman_count" id="fisherman_count"
                                   value="{{ old('fisherman_count') }}" min="0"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="area_size" id="area_size"
                                   value="{{ old('area_size') }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="production_volume" id="production_volume"
                                   value="{{ old('production_volume') }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="production_value" id="production_value"
                                   value="{{ old('production_value') }}" min="0" step="0.01"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="main_commodities" id="main_commodities"
                               value="{{ old('main_commodities') }}" maxlength="255"
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="crab_farmer_count" id="crab_farmer_count" value="{{ old('crab_farmer_count') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('crab_farmer_count') border-red-500 @enderror">
                    </div>
                    
                    <!-- Rumput Laut -->
                    <div>
                        <label for="seaweed_farmer_count" class="block text-sm font-medium text-gray-700 mb-2">Rumput Laut</label>
                        <input type="number" name="seaweed_farmer_count" id="seaweed_farmer_count" value="{{ old('seaweed_farmer_count') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('seaweed_farmer_count') border-red-500 @enderror">
                    </div>
                    
                    <!-- Kerang -->
                    <div>
                        <label for="clam_farmer_count" class="block text-sm font-medium text-gray-700 mb-2">Kerang</label>
                        <input type="number" name="clam_farmer_count" id="clam_farmer_count" value="{{ old('clam_farmer_count') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('clam_farmer_count') border-red-500 @enderror">
                    </div>
                    
                    <!-- Lobster -->
                    <div>
                        <label for="lobster_farmer_count" class="block text-sm font-medium text-gray-700 mb-2">Lobster</label>
                        <input type="number" name="lobster_farmer_count" id="lobster_farmer_count" value="{{ old('lobster_farmer_count') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('lobster_farmer_count') border-red-500 @enderror">
                    </div>
                    
                    <!-- Abalon -->
                    <div>
                        <label for="abalone_farmer_count" class="block text-sm font-medium text-gray-700 mb-2">Abalon</label>
                        <input type="number" name="abalone_farmer_count" id="abalone_farmer_count" value="{{ old('abalone_farmer_count') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('abalone_farmer_count') border-red-500 @enderror">
                    </div>
                    
                    <!-- Teripang -->
                    <div>
                        <label for="sea_cucumber_farmer_count" class="block text-sm font-medium text-gray-700 mb-2">Teripang</label>
                        <input type="number" name="sea_cucumber_farmer_count" id="sea_cucumber_farmer_count" value="{{ old('sea_cucumber_farmer_count') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('sea_cucumber_farmer_count') border-red-500 @enderror">
                    </div>
                    
                    <!-- Lainnya -->
                    <div>
                        <label for="other_farmer_count" class="block text-sm font-medium text-gray-700 mb-2">Lainnya</label>
                        <input type="number" name="other_farmer_count" id="other_farmer_count" value="{{ old('other_farmer_count') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('other_farmer_count') border-red-500 @enderror">
                    </div>
