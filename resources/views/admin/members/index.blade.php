...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="{{ route('admin.members.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
    ...
    <div class="bg-white rounded-lg shadow p-4">
        <form method="GET" action="{{ route('admin.members.index') }}" class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.members.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($member->avatar)
                                <img class="h-12 w-12 rounded-full object-cover" src="{{ asset('storage/' . $member->avatar) }}" alt="{{ $member->name }}">
                            @else
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $member->member_number }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                <button onclick="confirmDelete('delete-form-{{ $member->id }}')" 
